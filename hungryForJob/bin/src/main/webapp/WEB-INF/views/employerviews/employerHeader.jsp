        ...
        <div class="d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar">
            ...
            <ul id="menuContainer">
              ...
              <!-- <li> <a href="manage-folders.html">Home </a></li>
              ...
              <li class="dropdown"><a href="javascript:void(0)">Folders <i class="bi bi-chevron-down"></i> </a>
                <ul>

                  <li><a href="manage-folders.html">Manage Folders </a></li>
                </ul>
              </li> -->
            </ul>
