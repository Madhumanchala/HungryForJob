...
<body>
          ...
          <div class="col-xl-9 col-lg-8 col-md-8">
            <div class="jobdetails-content Profile-details mb-4">
              <div class="d-flex justify-content-between">
                ...
                <button class="edit-profile-button" data-bs-toggle="modal" data-bs-target="#Company-Profile-edit" onclick="companyProfileDetails()"> <i
                ...
                <div class="content-txt">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      ...
                      <h5 id="companyProfile_EmailforCommunuication"> ${companydetails.emailId} </h5>
                    </div>
                   ...
                   <!--  <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>Mobile Number</p>
                      <h5 id="companyProfile_MobileNumber">+91- ${companydetails.mobileNumber}</h5>
                    </div>
            ...
            <div class="jobdetails-content Profile-details mb-4">
              <div class="d-flex justify-content-between">
                ...
                <button class="edit-profile-button" data-bs-toggle="modal" data-bs-target="#Company-details-edit"> <i
                    class="bi bi-pencil"></i> Edit</button>
              </div>
              <div class="line2"></div>
              <div class="mt-3">
                <div class="content-txt">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>Industry Type </p>
                      <h5>${companydetails.industryType}</h5>
                    </div>
                   ...
                   <!--  <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>Phone Number </p>
                      <h5>${companydetails.mobileNumber}</h5>
                    </div>
                   <!--  <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>Phone Number 2</p>
                      <h5>9876543210</h5>
            ...
            <div class="jobdetails-content Profile-details">
              <div class="d-flex justify-content-between">
                ...
                <button class="edit-profile-button" data-bs-toggle="modal" data-bs-target="#KYC-Compliance-details"> <i
                    class="bi bi-pencil"></i> Edit</button>
              </div>
              <div class="line2"></div>
              <div class="mt-3">
                <div class="content-txt">
                  <div class="row">
                   ...
                   <!--  <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>State</p>
                      <h5>${companydetails.state}</h5>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>City </p>
                      <h5>${companydetails.city}</h5>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>Pin Code</p>
                      <h5>${companydetails.pincode}</h5>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                      <p>GSTIN </p>
                      <h5>${companydetails.gstnumber}</h5>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="modal fade" id="Company-Profile-edit" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                ...
                <span class="errors" id="editUserName_error"></span>
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">Email for Communication</label>
                <input type="text" name="" id="editEmailForComunuication" class="form-control" 
                  placeholder="Enter">
                 <span class="errors" id="editEmailCommunication_error"></span>
              </div>
            </div>
            <!-- <div class="col-lg-4 col-md-4">
              <div class="form-group">
           ...
           <!--  <div class="col-lg-4 col-md-4">
            ...
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="" id="editMobileNumber" class="form-control"  placeholder="Enter">
                <span class="errors" id="editMobileNo_error"></span>
              </div>
            </div>
  ...
  <div class="modal fade" id="Company-details-edit" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body pe-4 ps-4 py-4">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">Industry Type </label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Corporate House">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
        ...
        <div class="modal-footer">
          <button type="button" class="btn" data-bs-dismiss="modal">Cancel</button>
          <button type="button" class="btns">Update</button>
        </div>
  ...
  <div class="modal fade" id="KYC-Compliance-details" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit KYC Compliance Details</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body pe-4 ps-4 py-4">
          <div class="row">
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">KYC Status</label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Pending">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">PAN Number </label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="BEDPA5432P">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">Name on PAN Card </label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="john legend">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Primary Address">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">Address </label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Mumbai">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">Country </label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="India">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">State</label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Maharashtra">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="400001">
              </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="form-group">
                <label for="" class="form-label">GSTIN</label>
                <input type="text" name="" id="" class="form-control" placeholder="Enter" value="Unregistered">
              </div>
            </div>
          </div>
