...
<header id="header" class="header fixed-top">
  ...
  <div class="offcanvas offcanvas-end availablehead" tabindex="-1" id="offcanvasRight"
    ...
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasRightLabel"> <img src="employer/img/available-credits.svg"> Available Credits</h5>
    ...
    <div class="offcanvas-body availableCredits">
      <div class="progressbar ">
        <div class="jobPostings mb-3">
          <div class="d-flex align-items-center justify-content-between">
            <h4><svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
