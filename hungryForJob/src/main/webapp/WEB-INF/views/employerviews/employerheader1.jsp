			...
			<div class="adminEmp" id="employeradminheader">
				<div class="switcher">
					<input type="radio" name="balance" value="Admin" id="Admin"
						...
						onchange="route('companydashboard')" checked> <label
						for="Admin" class="switcher-label">Admin</label> <input
						type="radio" name="balance" value="Employer" id="Employer"
						class="switcher-input switcher-input--emp"
						onchange="route('searchCandidates')"> <label
