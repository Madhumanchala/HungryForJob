										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												<label for="Jobtitle" class="required">Job Title</label> <input
													...
													onkeyup="allJobChangeTittle()"> <span
												...
												<div class="formchecks">
													<ul>
														<li><input type="radio" class="btn-check"
															...
															onchange="allChange('employmentType_error')"> <label
												...
												<div class="formchecks">
													<ul>
														...
														<li><input type="radio" class="btn-check"
															...
															onchange="allChange('workMode_error')"> <label
															class="btn" for="onfield"><span>On field </span>
														</label></li>

														<li><input type="radio" class="btn-check"
															name="workMode" id="onfield" value="HYBRID"
															onchange="allChange('workMode_error')"> <label
													...
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="form-group">
															<label for="companyName" class="required">Company
																...
																onkeyup="changeCompanyName()" maxlength="30"> <span
													...
													<div class="col-lg-6 col-md-6 col-sm-12">
														<div class="form-group">
															<label for="emailId" class="required">Email Id </label> <input
																...
																maxlength="40" placeholder="Enter Email Id"
																onkeyup="changeEmailId()"> <span class="errors"
																id="emailId_error"></span>
														</div>
													</div>
						...
						<div class="card-register jd-preview-main" style="display: none;">
							...
							<div class="card-registerinner ">
								<div class="jd-preview">
									<h4>Job Title</h4>
									<p id="jobTittleHeading"></p>
									<h6 id="revireIndustry"></h6>
									<ul>
										<li><img src="employer/img/location.svg"><span
											id="reviewLocation"></span>  </li>
										<li><img src="employer/img/years.svg"><span
	...
	<script>
	  $(function () {
		...
		$(document).ready(function() {
			...
			var isVisibleFlag = "${isVisibleFlag}"; // safely capture as string
