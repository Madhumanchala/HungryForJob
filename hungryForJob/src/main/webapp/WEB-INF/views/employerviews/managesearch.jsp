...
<body class="bg">
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="manageFolders d-flex justify-content-between mb-3">
							...
							<button class="btn-blue" onclick="findroute('/searchCandidates')">
								New Search</button>
						</div>
					</div>
				</div>
						...
						<div class="advancedsearch-list manage-check">
                            ...
                            "savedReadyToLocate": "${details.savedReadyToLocate}"
											...
											<div class="candidatesTxt ">
												<h5 class="resultcandidate"
													onclick='callResultSearchCandidates({
    "foldername": "${details.foldername}",
    "skills": "${details.skills}",
    "id": "${details.id}",
    "userId": "${details.userId}",
    ...
    "savedReadyToLocate": "${details.savedReadyToLocate}"
													...
													<a href="#"> <i class="bi bi-search" aria-hidden="true"></i>
														Search
													</a>
												</h5>
												...
												<div class="dropdown ">
													...
													<ul class="dropdown-menu dropdown-menu-end">
														...
														<li><a class="dropdown-item" href="#"
															onclick="deletesearch(${details.id})"><i
