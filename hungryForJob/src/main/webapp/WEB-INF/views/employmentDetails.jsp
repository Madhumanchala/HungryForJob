          ...
          <div id="workContainerParent"> 
              <div id="workContainer" class="workContainer row">
              	<div class="col-lg-12">
                      <div class="form-group">
                        <div class="form-check currentlywork">
                          <input class="form-check-input currentlywork" type="checkbox" value="Active" id="currentlywork" onchange="updateCurrentlyWorking(this)" name="currentlywork">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class="form-group">
                    <label for="jobtitle" class="form-label required">Your Job title </label>
                    <input type="text" name="Job_Title" id="Job_Title" class="form-control" placeholder="Enter Job title" maxlength="80" required>
                  </div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-12">
                  <div class="form-group">
                    <label for="jobcompany" class="form-label required">Company Name </label>
                     <select class="selet2Single form-control  jobcompany" id="jobcompany" name="job_company"  onchange="companyChange(this)"  required="required">
                     </select>
...
%> 
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="form-group">
                    <label for="jobStartYear" class="form-label required">Start Year</label>
                    <select class="selet2Single form-control jobStartYear jobStartYear1" id="jobStartYear" name="jobStartYear" onchange="updatestartyear(this)" required>
                        <option value="" selected>Select</option>
                         <c:forEach var="i" begin="<%= newYear %>" end="<%= currentYear %>">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 endyeardiv">
                  <div class="form-group">
                    <label for="jobEndYear" class="form-label required">Till Year</label>
                    <select class="selet2Single form-control jobEndYear jobEndYear1" id="jobEndYear" name="jobEndYear" onchange="updatejobEndYear(this)">
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-6 endmonthdiv">
                  <div class="form-group">
                    ...
                    <span class="end_month_error errorfield" style="color:red"></span>
                  </div>
                  <span class="end_month_error errorfield"></span>
                </div> 
                 <div class="col-lg-12 col-md-6 col-sm-6">
                  
                <button type="button" class="btn btn-primary btn-md addSection">+</button>
                <button type="button" class="btn btn-danger btn-md deleteSection">-</button>
                </div>
              </div>      
            </div>
            <span class="maximum_skills_error errorfield"></span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  justify-content-end nextback">
                   <button type="button" class="btns" id="employmentRegisterSubmit"> Next </button>
                  </div>
                </div>
        </div>
  </div>
  ...
  <!-- employmentAddModal   -->
  <div class="modal fade" id="otherAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="form-group">
                <label for="NewcompanyName" class="form-label required">Company Name</label>
                <input type="text" name="NewcompanyName" id="NewcompanyName" class="form-control"
